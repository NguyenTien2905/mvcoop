                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="/assets/client/assets/img/post-sq-1.jpg" alt="" class="img-fluid me-3" />
                                <div>
                        ...
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="/assets/client/assets/img/post-sq-2.jpg" alt="" class="img-fluid me-3" />
                                <div>
                                    <div class="post-meta d-block">
                                        <span class="date">Culture</span>
                                        <span class="mx-1">&bullet;</span>
                                    ...
                                    <span>What is the son of Football Coach John Gruden, Deuce
                        ...
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="/assets/client/assets/img/post-sq-3.jpg" alt="" class="img-fluid me-3" />
                                <div>
                                    <div class="post-meta d-block">
                                        <span class="date">Culture</span>
                                        <span class="mx-1">&bullet;</span>
                                    ...
                                    <span>Life Insurance And Pregnancy: A Working Mom’s
                                        Guide</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="single-post.html" class="d-flex align-items-center">
                                <img src="/assets/client/assets/img/post-sq-4.jpg" alt="" class="img-fluid me-3" />
                                <div>
                                    <div class="post-meta d-block">
                                        <span class="date">Culture</span>
                                        <span class="mx-1">&bullet;</span>
                                    ...
                                    <span>How to Avoid Distraction and Stay Focused During Video
                                        Calls?</span>
                                </div>
                            </a>
                        </li>
